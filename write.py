...
def dictionary(file_contents):
    """
        Function converts file's content into dictionary.Takes content of a txt file as parameter.Returns a dictionary with integer keys starting from 1.
    """
    data = {}
...
def print_laptop(file_contents, mainData):
    """
        This function shows the list of the laptop by reading the file.Takes contents of the text file and the dictionary created as a parameter.
    """
    print("-----------------------------------------------------------------------------------\n")
...
def write_file(mainData):
    """
        This function writes in the selected text file.The quantity of the laptop is reduced if it is called in the sell file,and it is increased if it is called in the purchase
        method in the text file.
    """
...
def sell_bill(cart):
    """
        This function prints and writes the bill of the laptops that have been sold.Takes the list 'cart' as a parameter.
    """
    ...
    print("--------------------------------------------------------------------------------------------------")
    print("ID", "\t", "Costume Name", "\t", "Brand", "\t", "Price", "\t", "Quantity", "\t", "CPU", "\t\t", "Graphics")
    print("------------------------------------------------------------------------------------------------\n")
    ...
    for index in range(len(cart)):
        ...
        laptop_price = int(mainData[laptop_id][2].replace("$", ""))
        laptop_CPU = (mainData[laptop_id][4])
        laptop_Graphics = (mainData[laptop_id][5])
        xyz = laptop_price * laptop_quantity
        total += xyz
    ...
    file.write("\n\n-------------------------------------------------------------")
    file.write("\n        Thank you! The laptops have been purchased.          \n")
    file.write("-------------------------------------------------------------")
...
def purchase_bill(cart):
    """
        This function prints and writes the bill of the sells that have been purchase for store.Takes the list 'cart' as a parameter.
    """
